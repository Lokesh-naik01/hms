            ...
            <form action="updatemed.php" method="post">
                <div style="padding-left:200px;padding-right:200px;font-size:larger;">
                  <div class="container">
                    <div class="row">
                    <div class="col-xs-2">
                    <h1 style="padding-top:25px;"><center>Update Prescription</center></h1>
                      ...
                      <label for="mid" class="col-sm-2 col-form-label"><b>Medicine</b></label>
                        ...
                        <div class="form-group row" style="margin-right:20px;padding-top:10px;">
                          <label for="mquan" class="col-sm-2 col-form-label"><b>No of Units</b></label>
                            <div class="col-sm-7" style="margin-left:50px;">
                              <input type="text" class="form-control" name="mquan" value="<?php echo $row['mquan']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-right:20px;padding-top:10px;">
                          <label for="mmrng" class="col-sm-2 col-form-label"><b>Morning</b></label>
                            <div class="col-sm-7" style="margin-left:50px;">
                              <input required class="form-control" type="text" name="mmrng" value="<?php echo $row['mmrng']; ?>">
                        ...
                        <div class="form-group row" style="margin-right:20px;padding-top:10px;">
                          <label for="maft" class="col-sm-2 col-form-label"><b>Afternoon</b></label>
                            <div class="col-sm-7" style="margin-left:50px;">
                              <input required class="form-control" type="text" name="maft" value="<?php echo $row['maft']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-right:20px;padding-top:10px;">
                          <label for="mevng" class="col-sm-2 col-form-label"><b>Evening</b></label>
                            <div class="col-sm-7" style="margin-left:50px;">
                              <input required class="form-control" type="text" name="mevng" value="<?php echo $row['mevng']; ?>">
                            </div>
                        </div>
                        ...
                        <div class="form-group row" style="margin-right:20px;padding-top:10px;">
                          <label for="ndays" class="col-sm-2 col-form-label"><b>No of Days</b></label>
                            <div class="col-sm-7" style="margin-left:50px;">
                              <input required class="form-control" type="text" name="ndays" value="<?php echo $row['ndays']; ?>">
                            </div>
                        </div>
                    ...
                    <hr class="mb-3">
                        <input style="margin-left:350px;"class="btn btn-primary" id="register" type="submit" name="padd" value="Edit Medicine" onclick="return mess();">
