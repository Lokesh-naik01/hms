  ...
  <body>
    ...
    <div class="row2">
      ...
      <div class="column1 right1">
          ...
          <div class="tab">
           ...
           <?php
             if(isset($_POST['pdet']))
             {
               ...
               $sql=" SELECT * FROM appointment WHERE (did='$dval' AND adate='$adval' AND (pid='$data' OR pname LIKE '%".$data."%')) ";
             ...
             else
             {
               ...
               <?php
                 ...
                 else
                 {
                   $pag=1;
                       ...
                       $dval=$_SESSION["docid"];
                       $adval=date("Y-m-d");
                       //$sql=" SELECT * FROM appointment WHERE (did='$dval' AND adate='$adval' AND (pid='$data' OR pname LIKE '%".$data."%')) ORDER BY adate ASC LIMIT $start_from,$num_per_page";
                       $sql=" SELECT * FROM appointment WHERE did='$dval' AND adate>'$adval' ORDER BY adate ASC LIMIT $start_from,$num_per_page";
               ...
               <center>
                 ...
                 if($pag>1)
                 {
                      echo " <a href='apptod.php?pag=".($pag-1)."' class='btn btn-danger'>Previous</a> ";
                 }
                 for($i=1;$i<$total_page;$i++)
                 {
                       echo " <a href='apptod.php?pag=".$i."' class='btn btn-primary'>$i</a> ";
                 }
                 if($i>$pag)
                 {
                      echo " <a href='apptod.php?pag=".($pag+1)."' class='btn btn-danger'>Next</a> ";
                 }
                 ?>
               </center>
         <?php
         ...
         ?><h1><center>No Upcoming Appointments</center></h1><?php
       }
     }
             ?>
