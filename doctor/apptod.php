  ...
  <body>
    ...
    <div class="row2">
      ...
      <div class="column1 right1">
          ...
          <div class="tab">
           ...
           <?php
             if(isset($_POST['pdet']))
             {
               ...
               $sql=" SELECT * FROM appointment WHERE (did='$dval' AND adate='$adval' AND (aid LIKE '%".$data."%' OR pid LIKE '%".$data."%' OR pname LIKE '%".$data."%')) ";
                             ...
                             <tr>
                                   ...
                                   {?>
                                    ...
                                    <?php
                                     ...
                                     <td style="text-align:center;">
                                            <a style="background:#D22B2B;"href="view.php?id=<?php echo $row['aid']; ?>">View</a>
                                     </td>
                                     <?php
                                   }
                                    ?>
         ...
         <h1><center>No Appointments Today</center></h1><?php
       }
     }
             ?>
